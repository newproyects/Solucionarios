...
\newpage
\textbf{Problem 1.13} Let $\brc$ be the separation vector from a fixed point $(x',y',z')$
to the point $(x,y,z)$, and let $\rc$ be its length. Show that\\
...
\[\vec\rc=\vec r-\vec r'=(x-x')\hat\imath+(y-y')\hat\jmath+(z-z')\hat k\]

\[\rc=\sqrt{(x-x')^2+(y-y')^2+(z-z')^2}\]\\

\[\nabla(\rc^2)=\nabla\left[(x-x')^2+(y-y')^2+(z-z')^2\right]\]\\

\[\nabla(\rc^2)=\frac{\partial}{\partial x}(x-x')^2\hat\imath+\frac{\partial}{\partial y}(y-y')^2\hat\jmath+\frac{\partial}{\partial z}(z-z')^2\hat k\]\\

\[\nabla(\rc^2)=
2(x-x')\hat\imath+2(y-y')\hat\jmath+2(z-z')\hat k=
2\left[(x-x')\hat\imath+(y-y')\hat\jmath+(z-z')\hat k\right]\]\\

\[\boxed{\text{1.12 (a)}\quad\nabla(\rc^2)=2\vec\rc\quad\blacksquare}\]

\newpage
\[\nabla\left(\frac{1}{\rc}\right)=\nabla\left[(x-x')^2+(y-y')^2+(z-z')^2\right]^{-\frac{1}{2}}\]\\

\[\nabla\left(\frac{1}{\rc}\right)=\]
\[\frac{\partial}{\partial x}\left[(x-x')^2+(y-y')^2+(z-z')^2\right]^{-\frac{1}{2}}\hat\imath\]
\[+\frac{\partial}{\partial y}\left[(x-x')^2+(y-y')^2+(z-z')^2\right]^{-\frac{1}{2}}\hat\jmath\]
\[+\frac{\partial}{\partial z}\left[(x-x')^2+(y-y')^2+(z-z')^2\right]^{-\frac{1}{2}}\hat k\]\\

\[\nabla\left(\frac{1}{\rc}\right)=\]
\[-\frac{1}{2}\left[(x-x')^2+(y-y')^2+(z-z')^2\right]^{-\frac{3}{2}}
\left[\frac{\partial}{\partial x}(x-x')^2\hat\imath+\frac{\partial}{\partial y}(y-y')^2\hat\jmath+\frac{\partial}{\partial z}(z-z')^2\hat k\right]\]\\

\[\nabla\left(\frac{1}{\rc}\right)=
-\left[(x-x')^2+(y-y')^2+(z-z')^2\right]^{-\frac{3}{2}}
\left[(x-x')\hat\imath+(y-y')\hat\jmath+(z-z')\hat k\right]\]\\

\[\nabla\left(\frac{1}{\rc}\right)=
-\left(\rc^2\right)^{-\frac{3}{2}}\vec\rc=
-\frac{1}{\rc^3}\vec\rc=
-\frac{1}{\rc^2}\frac{\vec\rc}{\rc}\]\\

\[\hat\rc=\frac{\vec\rc}{\rc}\]\\

\[\boxed{\text{1.13 (b)}\quad\nabla\left(\frac{1}{\rc}\right)=-\frac{\hat\rc}{\rc^2}}\]

\newpage
\[\nabla(\rc^n)=\nabla\left[(x-x')^2+(y-y')^2+(z-z')^2\right]^\frac{n}{2}\]\\

\[\nabla(\rc^n)=\]
\[\frac{\partial}{\partial x}\left[(x-x')^2+(y-y')^2+(z-z')^2\right]^\frac{n}{2}\hat\imath\]
\[+\frac{\partial}{\partial y}\left[(x-x')^2+(y-y')^2+(z-z')^2\right]^\frac{n}{2}\hat\jmath\]
\[+\frac{\partial}{\partial z}\left[(x-x')^2+(y-y')^2+(z-z')^2\right]^\frac{n}{2}\hat k\]\\

\[\nabla(\rc^n)=\]
\[\frac{n}{2}\left[(x-x')^2+(y-y')^2+(z-z')^2\right]^{\frac{n}{2}-1}
\left[\frac{\partial}{\partial x}(x-x')^2\hat\imath+\frac{\partial}{\partial y}(y-y')^2\hat\jmath+\frac{\partial}{\partial z}(z-z')^2\hat k\right]\]\\

\[\nabla(\rc^n)=n\left[(x-x')^2+(y-y')^2+(z-z')^2\right]^{\frac{n}{2}-1}\left[(x-x')\hat\imath+(y-y')\hat\jmath+(z-z')\hat k\right]\]\\

\[\nabla(\rc^n)=n\left[(x-x')^2+(y-y')^2+(z-z')^2\right]^{\frac{1}{2}(n-2)}\left[(x-x')\hat\imath+(y-y')\hat\jmath+(z-z')\hat k\right]\]\\

\[\nabla(\rc^n)=n\rc^{n-2}\vec\rc=n\rc^{n-1}\frac{\vec\rc}{\rc}\]\\

\[\boxed{\text{1.13 (c)}\quad\nabla(\rc^n)=n\rc^{n-1}\hat\rc}\]\\
...
\[\therefore\quad\nabla\cdot\vec v=
3(x^2+y^2+z^2)^{-\frac{3}{2}}-3x^2(x^2+y^2+z^2)^{-\frac{5}{2}}-3y^2(x^2+y^2+z^2)^{-\frac{5}{2}}-3z^2(x^2+y^2+z^2)^{-\frac{5}{2}}\]\\

\[\nabla\cdot\vec v=3(x^2+y^2+z^2)^{-\frac{3}{2}}-3(x^2+y^2+z^2)(x^2+y^2+z^2)^{-\frac{5}{2}}\]
...
\begin{center}
  \fbox{\begin{minipage}{17cm}
      1.16
      \[\nabla\cdot\vec v=0\quad:\quad\vec v=\frac{\hat r}{r^2}\]
      La divergencia en todo el espacio es $\nabla\cdot\vec v=0$, con excepción del origen que es
      una ``fuente'', en el origen la función no esta definida, por lo que $\nabla\cdot\vec v$ tiende a
      infinito.
      \end{minipage}}
\end{center}
